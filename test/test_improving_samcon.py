...
from src.improving_samcon.improving_samcon import ImprovingSamcon
...
def main(**args):
    ...
    samcon = ImprovingSamcon(p, simTimeStep, sampleTimeStep, savePath)
...
if __name__ == '__main__':
    ...
    args = {
        ...
        'data_name': "humanoid3d_walk.txt",
        'save_path': './data/reconstructed_motion/improving_samcon/result_1.0.txt',
